...
public class PopupManager : MonoBehaviour {
  ...
  [SerializeField]
  PopupSkin default_canvas_skin_;
  ...
  void Awake() {
    ...
    default_canvas_skin_ = Resources.Load<PopupSkin>("Skins/PopupDefaultSkin");
  ...
  void ReloadPopupCanvas() {
    ...
    if (current_canvas_skin_ == null) current_canvas_skin_ = default_canvas_skin_;
    if (current_canvas_skin_.popup_background_image_ != null)
