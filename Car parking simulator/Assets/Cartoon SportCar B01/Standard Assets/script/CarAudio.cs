    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, m_CarController.car_movement().current_acceleration() / m_CarController.car_movement().max_acceleration_);
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(m_CarController.car_movement().current_acceleration());
                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, m_CarController.car_movement().current_acceleration() / m_CarController.car_movement().max_acceleration_);
